...
export const nl = {
  ...
  "settings.walk.title": "Loopsnelheid",
  "settings.walk.body": "De app gaat uit van stevig doorlopen (5 km/h), net als 9292. De planner zelf is voorzichtiger (4 km/h), en op een reis met drie loopstukken \u2014 naar de halte, de overstap, en het laatste stuk naar de deur \u2014 scheelt dat zo tien minuten. Loop je rustiger, zet het dan hier terug.",
  "settings.walk.slow": "Rustig",
  "settings.walk.slowHint": "Ongeveer 3 km/h; ruim de tijd om er te komen",
  "settings.walk.normal": "Normaal",
  "settings.walk.normalHint": "Ongeveer 4 km/h, de snelheid van de planner zelf",
  "settings.walk.fast": "Stevig",
  "settings.walk.fastHint": "Ongeveer 5 km/h, waar 9292 ook mee rekent (standaard)",
...
export const en: Record<TranslationKey, string> = {
  ...
  "settings.walk.title": "Walking speed",
  "settings.walk.body": "The app assumes a brisk pace (5 km/h), the same as 9292. The planner itself is more cautious (4 km/h), and on a journey with three walking legs \u2014 to the stop, the transfer, and the last bit to the door \u2014 that adds up to some ten minutes. If you walk more gently, set it back here.",
  "settings.walk.slow": "Gentle",
  "settings.walk.slowHint": "About 3 km/h; plenty of time to get there",
  "settings.walk.normal": "Normal",
  "settings.walk.normalHint": "About 4 km/h, the planner's own speed",
  "settings.walk.fast": "Brisk",
  "settings.walk.fastHint": "About 5 km/h, what 9292 assumes too (default)",
