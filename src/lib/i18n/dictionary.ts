...
export const nl = {
  ...
  "intro.body": "Dat is het hele idee. Jij zet erin wat je gaat doen en waar; de app rekent uit hoe laat je de deur uit moet, met de auto, de fiets of het OV, inclusief overstappen en vertragingen.",
  "intro.twoQuestions": "Twee vragen en je kunt beginnen.",
...
export const en: Record<TranslationKey, string> = {
  ...
  "intro.body": "That is the whole idea. You put in what you are doing and where; the app works out when you need to walk out the door, by car, by bike or by public transport, changes and delays included.",
  "intro.twoQuestions": "Two questions and you are ready to go.",
