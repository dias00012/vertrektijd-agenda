...
export const nl = {
  ...
  "places.noStreet.fix": "Gooi hem weg met het kruisje en kies hem opnieuw bij een activiteit, dan staat het juiste punt erin.",
...
export const en: Record<TranslationKey, string> = {
  ...
  "places.noStreet.fix": "Remove it with the cross and pick it again on an activity, so the right point gets stored.",
